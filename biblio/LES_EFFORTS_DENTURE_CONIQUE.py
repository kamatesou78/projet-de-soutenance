...
class Ui_DENTURE_CONIQUE(object):
    ...
    def perform_selected_calculation(self):
        ...
        try:
            ...
            b = float(self.lineEdit2_1.text())
            Σ = float(self.lineEdit2_2.text())
            P = float(self.lineEdit3.text())
            N = float(self.lineEdit4.text())
            Z1 = int(self.lineEdit5.text())  
            Z2 = int(self.lineEdit5_1.text())
            ...
            if R == "pignon":
                if Σ == 90:
                    ...
                    δ1 = math.degrees(δ11)
                    C1 = (30*P)/(math.pi*N)
                    FT1 = (C1/(((m*Z1)/2)-(0.5*b*math.sin(math.radians(δ1)))))*1000
                    FA1 = FT1*math.tan(math.radians(alpha))*math.sin(math.radians(δ1))
                    FR1 = FT1*math.tan(math.radians(alpha))*math.cos(math.radians(δ1))
                ...
                if Σ == 90 :
                    ...
                    δ2 = math.degrees(δ22)
                    C2 = (30*P)/(math.pi*N)
                    FT2 = (C2/(((m*Z2)/2)-(0.5*b*math.sin(math.radians(δ2)))))*1000
                    FA2 = FT2*math.tan(math.radians(alpha))*math.sin(math.radians(δ2))
                    FR2 = FT2*math.tan(math.radians(alpha))*math.cos(math.radians(δ2))
                    F2 = FT2/math.cos(math.radians(alpha))
    ...
    def sauvegarder_dans_excel(self):
        ...
        symboles = [
            'm', '∝', 'b', 'Σ', 'P', 'N', 'Zpignon', 'Zroue', 'η', 'C1', 'FT1', 'FA1', 'FR1', 'F1', 'C2', 'FT2', 'FA2', 'FR2', 'F2'
        ]
        ...
        unites = [
            ...
            'mm', 'degré', 'mm', 'degré', 'W', 'tr/mn', '', '', '%', 'N.m', 'N', 'N', 'N', 'N', 'N.m', 'N', 'N', 'N', 'N'
        ]
    ...
    def setupUi(self, DENTURE_CONIQUE):        
        DENTURE_CONIQUE.setObjectName("DENTURE_CONIQUE")
        DENTURE_CONIQUE.setWindowModality(QtCore.Qt.WindowModal)
        DENTURE_CONIQUE.resize(550, 372)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../../../../.designer/backup/reducteur_gearexpert.gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        DENTURE_CONIQUE.setWindowIcon(icon)
        self.gridLayout = QtWidgets.QGridLayout(DENTURE_CONIQUE)
        self.gridLayout.setObjectName("gridLayout")
        self.scrollArea = QtWidgets.QScrollArea(DENTURE_CONIQUE)
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 523, 1036))
        ...
        self.gridLayout_2.addWidget(self.label5, 6, 0, 1, 1, QtCore.Qt.AlignLeft)
        ...
        self.gridLayout_2.addWidget(self.label_30, 6, 1, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.gridLayout_2.addWidget(self.lineEdit5, 6, 3, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.gridLayout_2.addWidget(self.label_49, 8, 1, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.gridLayout_2.addWidget(self.lineEdit6, 8, 3, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.gridLayout_2.addWidget(self.label6, 8, 0, 1, 1, QtCore.Qt.AlignLeft)
        ...
        self.gridLayout_2.addWidget(self.label_32, 7, 1, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.gridLayout_2.addWidget(self.lineEdit5_1, 7, 3, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.label5_1 = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.gridLayout_2.addWidget(self.label5_1, 7, 0, 1, 1)
        ...
        self.retranslateUi(DENTURE_CONIQUE)
        QtCore.QMetaObject.connectSlotsByName(DENTURE_CONIQUE)

    def retranslateUi(self, DENTURE_CONIQUE):
        _translate = QtCore.QCoreApplication.translate
        DENTURE_CONIQUE.setWindowTitle(_translate("DENTURE_CONIQUE", "DENTURE_CONIQUE"))
        self.label_2.setText(_translate("DENTURE_CONIQUE", "Valeurs d\'entrée"))
        self.label_7.setText(_translate("DENTURE_CONIQUE", "Veuillez choisir celui/celle qui est le/la menant/menante"))
        self.radioButton_2.setText(_translate("DENTURE_CONIQUE", "Roue"))
        self.radioButton.setText(_translate("DENTURE_CONIQUE", "Pignon"))
        self.label_52.setText(_translate("DENTURE_CONIQUE", "b"))
        self.label5.setText(_translate("DENTURE_CONIQUE", "Nombre de dent  pignon"))
        self.label_154.setText(_translate("DENTURE_CONIQUE", "P"))
        self.label_30.setText(_translate("DENTURE_CONIQUE", "Zpignon"))
        self.label1.setText(_translate("DENTURE_CONIQUE", "Module normalisé"))
        self.label3.setText(_translate("DENTURE_CONIQUE", "Puissance"))
        self.label_27.setText(_translate("DENTURE_CONIQUE", "∝"))
        self.label2.setText(_translate("DENTURE_CONIQUE", "Angle de pression reél"))
        self.label_25.setText(_translate("DENTURE_CONIQUE", "m"))
        self.label4.setText(_translate("DENTURE_CONIQUE", "Nombre de tr/min"))
        self.label_170.setText(_translate("DENTURE_CONIQUE", "N"))
        self.label_49.setText(_translate("DENTURE_CONIQUE", "η"))
        self.label6.setText(_translate("DENTURE_CONIQUE", "Rendement"))
        self.label_54.setText(_translate("DENTURE_CONIQUE", "Σ"))
        self.label2_2.setText(_translate("DENTURE_CONIQUE", "Angle de croisement"))
        self.label_32.setText(_translate("DENTURE_CONIQUE", "Zroue"))
        self.label2_1.setText(_translate("DENTURE_CONIQUE", "Largeur de dent"))
        self.label5_1.setText(_translate("DENTURE_CONIQUE", "Nombre de dent  roue"))
        self.pushButton.setText(_translate("DENTURE_CONIQUE", "CALCULEZ"))
        self.pushButton_3.setText(_translate("DENTURE_CONIQUE", "SAUVEGARDEZ LES RESULTATS DU CALCUL"))
        self.label_45.setText(_translate("DENTURE_CONIQUE", "Valeurs de sortie"))
        self.label_46.setText(_translate("DENTURE_CONIQUE", "Les efforts pour le pignon"))
        self.label_53.setText(_translate("DENTURE_CONIQUE", "F1"))
        self.label9.setText(_translate("DENTURE_CONIQUE", "Effort radial"))
        self.label10.setText(_translate("DENTURE_CONIQUE", "Effort sur la dent"))
        self.label_60.setText(_translate("DENTURE_CONIQUE", "FR1"))
        self.label_82.setText(_translate("DENTURE_CONIQUE", "C1"))
        self.label7.setText(_translate("DENTURE_CONIQUE", "Couple"))
        self.label_83.setText(_translate("DENTURE_CONIQUE", "FT1"))
        self.label8.setText(_translate("DENTURE_CONIQUE", "Effort tangentiel"))
        self.label8_1.setText(_translate("DENTURE_CONIQUE", "Effort axial"))
        self.label_88.setText(_translate("DENTURE_CONIQUE", "FA1"))
        self.label_50.setText(_translate("DENTURE_CONIQUE", "Les efforts pour la roue"))
        self.label12.setText(_translate("DENTURE_CONIQUE", "Effort tangentiel"))
        self.label_87.setText(_translate("DENTURE_CONIQUE", "FT2"))
        self.label11.setText(_translate("DENTURE_CONIQUE", "Couple"))
        self.label_55.setText(_translate("DENTURE_CONIQUE", "F2"))
        self.label14.setText(_translate("DENTURE_CONIQUE", "Effort sur la dent"))
        self.label13.setText(_translate("DENTURE_CONIQUE", "Effort radial"))
        self.label_62.setText(_translate("DENTURE_CONIQUE", "FR2"))
        self.label_86.setText(_translate("DENTURE_CONIQUE", "C2"))
        self.label12_1.setText(_translate("DENTURE_CONIQUE", "Effort axial"))
        self.label_89.setText(_translate("DENTURE_CONIQUE", "FA2"))
        self.pushButton_2.setText(_translate("DENTURE_CONIQUE", "RETOUR"))
...
if __name__ == "__main__":
    ...
    ui = Ui_DENTURE_CONIQUE()
    ui.setupUi(DENTURE_CONIQUE)
    DENTURE_CONIQUE.show()
    sys.exit(app.exec_())
