...
class Ui_DENTURE_HELICOIDALE_PARALLELE(object):
    ...
    def calculer_engrenage(self):
        try:
            ...
            C1 = (30*P)/(math.pi*N)
            FT1 = ((2*C1)/((m*Zm)/(math.cos(math.radians(β)))))*1000
            FA1 = FT1*math.tan(math.radians(β))
            FR1 = FT1*(math.tan(math.radians(alpha))/math.cos(math.radians(β)))
            F1 = FT1/(math.cos(math.radians(β))*math.cos(math.radians(alpha)))
    ...
    def sauvegarder_dans_excel(self):
        ...
        symboles = [
            'mn', '∝', 'β', 'P', 'N', 'Z', 'η', 'C1', 'FT1', 'FA1', 'FR1', 'F1', 'C2', 'FT2', 'FA2', 'FR2', 'F2'
        ]
        ...
        unites = [
            ...
            'mm', 'degré', 'degré', 'W', 'tr/mn', '', '%', 'N.m', 'N', 'N', 'N', 'N', 'N.m', 'N', 'N', 'N', 'N'
        ]
    ...
    def setupUi(self, DENTURE_HELICOIDALE_PARALLELE):
        DENTURE_HELICOIDALE_PARALLELE.setObjectName("DENTURE_HELICOIDALE_PARALLELE")
        DENTURE_HELICOIDALE_PARALLELE.setWindowModality(QtCore.Qt.WindowModal)
        DENTURE_HELICOIDALE_PARALLELE.resize(550, 372)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../../../../.designer/backup/reducteur_gearexpert.gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        DENTURE_HELICOIDALE_PARALLELE.setWindowIcon(icon)
        self.gridLayout = QtWidgets.QGridLayout(DENTURE_HELICOIDALE_PARALLELE)
        self.gridLayout.setObjectName("gridLayout")
        self.scrollArea = QtWidgets.QScrollArea(DENTURE_HELICOIDALE_PARALLELE)
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 523, 896))
        ...
        self.gridLayout_2.addWidget(self.label5, 5, 0, 1, 1, QtCore.Qt.AlignLeft)
        ...
        self.gridLayout_2.addWidget(self.label_154, 3, 1, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.gridLayout_2.addWidget(self.label_30, 5, 1, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.gridLayout_2.addWidget(self.label3, 3, 0, 1, 1, QtCore.Qt.AlignLeft)
        ...
        self.gridLayout_2.addWidget(self.lineEdit4, 4, 3, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.gridLayout_2.addWidget(self.label4, 4, 0, 1, 1, QtCore.Qt.AlignLeft)
        ...
        self.gridLayout_2.addWidget(self.lineEdit5, 5, 3, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.gridLayout_2.addWidget(self.label_170, 4, 1, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.gridLayout_2.addWidget(self.label_49, 6, 1, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.gridLayout_2.addWidget(self.lineEdit6, 6, 3, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.gridLayout_2.addWidget(self.lineEdit3, 3, 3, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.gridLayout_2.addWidget(self.label6, 6, 0, 1, 1, QtCore.Qt.AlignLeft)
        ...
        self.retranslateUi(DENTURE_HELICOIDALE_PARALLELE)
        QtCore.QMetaObject.connectSlotsByName(DENTURE_HELICOIDALE_PARALLELE)

    def retranslateUi(self, DENTURE_HELICOIDALE_PARALLELE):
        _translate = QtCore.QCoreApplication.translate
        DENTURE_HELICOIDALE_PARALLELE.setWindowTitle(_translate("DENTURE_HELICOIDALE_PARALLELE", "DENTURE_HELICOIDALE_PARALLELE"))
        self.label_2.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "Valeurs d\'entrée"))
        self.label5.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "Nombre de dent pour la roue menante"))
        self.label_154.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "P"))
        self.label_30.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "Z"))
        self.label1.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "Module normalisé"))
        self.label3.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "Puissance"))
        self.label_27.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "∝"))
        self.label2.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "Angle de pression reél"))
        self.label_25.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "m"))
        self.label4.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "Nombre de tr/min"))
        self.label_170.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "N"))
        self.label_49.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "η"))
        self.label6.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "Rendement"))
        self.label2_1.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "Angle d\'hélice"))
        self.label_52.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "β"))
        self.pushButton.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "CALCULEZ"))
        self.pushButton_3.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "SAUVEGARDEZ LES RESULTATS DU CALCUL"))
        self.label_45.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "Valeurs de sortie"))
        self.label_46.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "Roue menante"))
        self.label_53.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "F1"))
        self.label9.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "Effort radial"))
        self.label10.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "Effort sur la dent"))
        self.label_60.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "FR1"))
        self.label_82.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "C1"))
        self.label7.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "Couple"))
        self.label_83.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "FT1"))
        self.label8.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "Effort tangentiel"))
        self.label8_1.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "Effort axial"))
        self.label_88.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "FA1"))
        self.label_50.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "Roue meneé"))
        self.label12.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "Effort tangentiel"))
        self.label_87.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "FT2"))
        self.label11.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "Couple"))
        self.label_55.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "F2"))
        self.label14.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "Effort sur la dent"))
        self.label13.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "Effort radial"))
        self.label_62.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "FR2"))
        self.label_86.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "C2"))
        self.label12_1.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "Effort axial"))
        self.label_89.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "FA2"))
        self.pushButton_2.setText(_translate("DENTURE_HELICOIDALE_PARALLELE", "RETOUR"))
...
if __name__ == "__main__":
    ...
    ui = Ui_DENTURE_HELICOIDALE_PARALLELE()
    ui.setupUi(DENTURE_HELICOIDALE_PARALLELE)
    DENTURE_HELICOIDALE_PARALLELE.show()
    sys.exit(app.exec_())
