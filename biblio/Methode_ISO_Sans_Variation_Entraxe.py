...
class Ui_METHODE_ISO_SANS_VARIATION_ENTRAXE(object):
    ...
    def setupUi(self, METHODE_ISO_SANS_VARIATION_ENTRAXE):
        METHODE_ISO_SANS_VARIATION_ENTRAXE.setObjectName("METHODE_ISO_SANS_VARIATION_ENTRAXE")
        METHODE_ISO_SANS_VARIATION_ENTRAXE.resize(1119, 438)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("reducteur_gearexpert.gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        METHODE_ISO_SANS_VARIATION_ENTRAXE.setWindowIcon(icon)
        self.gridLayout_2 = QtWidgets.QGridLayout(METHODE_ISO_SANS_VARIATION_ENTRAXE)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.scrollArea = QtWidgets.QScrollArea(METHODE_ISO_SANS_VARIATION_ENTRAXE)
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1105, 424))
        ...
        self.retranslateUi(METHODE_ISO_SANS_VARIATION_ENTRAXE)
        QtCore.QMetaObject.connectSlotsByName(METHODE_ISO_SANS_VARIATION_ENTRAXE)

    def retranslateUi(self, METHODE_ISO_SANS_VARIATION_ENTRAXE):
        _translate = QtCore.QCoreApplication.translate
        METHODE_ISO_SANS_VARIATION_ENTRAXE.setWindowTitle(_translate("METHODE_ISO_SANS_VARIATION_ENTRAXE", "METHODE_ISO_SANS_VARIATION_ENTRAXE"))
        self.label.setText(_translate("METHODE_ISO_SANS_VARIATION_ENTRAXE", "                     DETERMINATION DES DEPORTS AVEC LA METHODE ISO\n"
"                                         SANS VARIATION D\'ENTRAXE"))
        self.label_2.setText(_translate("METHODE_ISO_SANS_VARIATION_ENTRAXE", "Valeurs d\'entrée"))
        self.label_3.setText(_translate("METHODE_ISO_SANS_VARIATION_ENTRAXE", "Nombre de dent"))
        self.label_4.setText(_translate("METHODE_ISO_SANS_VARIATION_ENTRAXE", "Z1"))
        self.label_5.setText(_translate("METHODE_ISO_SANS_VARIATION_ENTRAXE", "Z2"))
        self.pushButton.setText(_translate("METHODE_ISO_SANS_VARIATION_ENTRAXE", "CALCULEZ"))
        self.pushButton_1.setText(_translate("METHODE_ISO_SANS_VARIATION_ENTRAXE", "SAUVEGARDER LES RESULTATS DU CALCUL"))
        self.label_6.setText(_translate("METHODE_ISO_SANS_VARIATION_ENTRAXE", "Valeurs de sortie"))
        self.label_7.setText(_translate("METHODE_ISO_SANS_VARIATION_ENTRAXE", "Les deports"))
        self.label_8.setText(_translate("METHODE_ISO_SANS_VARIATION_ENTRAXE", "X1"))
        self.label_9.setText(_translate("METHODE_ISO_SANS_VARIATION_ENTRAXE", "X2"))
        self.pushButton_2.setText(_translate("METHODE_ISO_SANS_VARIATION_ENTRAXE", "RETOUR"))
...
if __name__ == "__main__":
    ...
    ui = Ui_METHODE_ISO_SANS_VARIATION_ENTRAXE()
    ui.setupUi(METHODE_ISO_SANS_VARIATION_ENTRAXE)
