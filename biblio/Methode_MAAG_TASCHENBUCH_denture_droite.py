...
class Ui_METHODE_MAAG_TASCHENBUCH_D_DROITE(object):
    ...
    def setupUi(self, METHODE_MAAG_TASCHENBUCH_D_DROITE):
        METHODE_MAAG_TASCHENBUCH_D_DROITE.setObjectName("METHODE_MAAG_TASCHENBUCH_D_DROITE")
        METHODE_MAAG_TASCHENBUCH_D_DROITE.resize(645, 480)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("reducteur_gearexpert.gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        METHODE_MAAG_TASCHENBUCH_D_DROITE.setWindowIcon(icon)
        self.gridLayout_2 = QtWidgets.QGridLayout(METHODE_MAAG_TASCHENBUCH_D_DROITE)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.scrollArea = QtWidgets.QScrollArea(METHODE_MAAG_TASCHENBUCH_D_DROITE)
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 736, 453))
        ...
        self.retranslateUi(METHODE_MAAG_TASCHENBUCH_D_DROITE)
        QtCore.QMetaObject.connectSlotsByName(METHODE_MAAG_TASCHENBUCH_D_DROITE)

    def retranslateUi(self, METHODE_MAAG_TASCHENBUCH_D_DROITE):
        _translate = QtCore.QCoreApplication.translate
        METHODE_MAAG_TASCHENBUCH_D_DROITE.setWindowTitle(_translate("METHODE_MAAG_TASCHENBUCH_D_DROITE", "METHODE_MAAG_TASCHENBUCH_D_DROITE"))
        self.label.setText(_translate("METHODE_MAAG_TASCHENBUCH_D_DROITE", "METHODE DE MAAG-TASCHENBUCH  POUR LA DENTURE DROITE "))
        self.label_2.setText(_translate("METHODE_MAAG_TASCHENBUCH_D_DROITE", "Valeurs d\'entrée"))
        self.label_47.setText(_translate("METHODE_MAAG_TASCHENBUCH_D_DROITE", "a\'"))
        self.label_31.setText(_translate("METHODE_MAAG_TASCHENBUCH_D_DROITE", "Z1"))
        self.label_46.setText(_translate("METHODE_MAAG_TASCHENBUCH_D_DROITE", "Z2"))
        self.label_11.setText(_translate("METHODE_MAAG_TASCHENBUCH_D_DROITE", "Entraxe de fonctionnement"))
        self.label_5.setText(_translate("METHODE_MAAG_TASCHENBUCH_D_DROITE", "Nombre de dent"))
        self.pushButton.setText(_translate("METHODE_MAAG_TASCHENBUCH_D_DROITE", "CALCULEZ"))
        self.pushButton_3.setText(_translate("METHODE_MAAG_TASCHENBUCH_D_DROITE", "SAUVEGARDER LES RESULTATS DU CALCUL"))
        self.label_45.setText(_translate("METHODE_MAAG_TASCHENBUCH_D_DROITE", "Valeurs de sortie"))
        self.label_7.setText(_translate("METHODE_MAAG_TASCHENBUCH_D_DROITE", "Les deports"))
        self.label_8.setText(_translate("METHODE_MAAG_TASCHENBUCH_D_DROITE", "X1"))
        self.label_9.setText(_translate("METHODE_MAAG_TASCHENBUCH_D_DROITE", "X2"))
        self.pushButton_2.setText(_translate("METHODE_MAAG_TASCHENBUCH_D_DROITE", "RETOUR"))
...
if __name__ == "__main__":
    ...
    ui = Ui_METHODE_MAAG_TASCHENBUCH_D_DROITE()
    ui.setupUi(METHODE_MAAG_TASCHENBUCH_D_DROITE)
