...
class Ui_METHODE_ISO_D_HELICOIDALE(object):
    ...
    def setupUi(self, METHODE_ISO_D_HELICOIDALE):
        METHODE_ISO_D_HELICOIDALE.setObjectName("METHODE_ISO_D_HELICOIDALE")
        METHODE_ISO_D_HELICOIDALE.resize(645, 480)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("reducteur_gearexpert.gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        METHODE_ISO_D_HELICOIDALE.setWindowIcon(icon)
        self.gridLayout_2 = QtWidgets.QGridLayout(METHODE_ISO_D_HELICOIDALE)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.scrollArea = QtWidgets.QScrollArea(METHODE_ISO_D_HELICOIDALE)
        ...
        self.retranslateUi(METHODE_ISO_D_HELICOIDALE)
        QtCore.QMetaObject.connectSlotsByName(METHODE_ISO_D_HELICOIDALE)

    def retranslateUi(self, METHODE_ISO_D_HELICOIDALE):
        _translate = QtCore.QCoreApplication.translate
        METHODE_ISO_D_HELICOIDALE.setWindowTitle(_translate("METHODE_ISO_D_HELICOIDALE", "METHODE_ISO_D_HELICOIDALE"))
        self.label.setText(_translate("METHODE_ISO_D_HELICOIDALE", "METHODE ISO  POUR LA DENTURE HELICOIDALE"))
        self.label_2.setText(_translate("METHODE_ISO_D_HELICOIDALE", "Valeurs d\'entrée"))
        self.label_47.setText(_translate("METHODE_ISO_D_HELICOIDALE", "a\'"))
        self.label_31.setText(_translate("METHODE_ISO_D_HELICOIDALE", "Z1"))
        self.label_46.setText(_translate("METHODE_ISO_D_HELICOIDALE", "Z2"))
        self.label_3.setText(_translate("METHODE_ISO_D_HELICOIDALE", "Angle d\'hélice"))
        self.label_4.setText(_translate("METHODE_ISO_D_HELICOIDALE", "β"))
        self.label_11.setText(_translate("METHODE_ISO_D_HELICOIDALE", "Entraxe de fonctionnement"))
        self.label_5.setText(_translate("METHODE_ISO_D_HELICOIDALE", "Nombre de dent"))
        self.pushButton.setText(_translate("METHODE_ISO_D_HELICOIDALE", "CALCULEZ"))
        self.pushButton_3.setText(_translate("METHODE_ISO_D_HELICOIDALE", "SAUVEGARDER LES RESULTATS DU CALCUL"))
        self.label_45.setText(_translate("METHODE_ISO_D_HELICOIDALE", "Valeurs de sortie"))
        self.label_7.setText(_translate("METHODE_ISO_D_HELICOIDALE", "Les deports"))
        self.label_8.setText(_translate("METHODE_ISO_D_HELICOIDALE", "X1"))
        self.label_9.setText(_translate("METHODE_ISO_D_HELICOIDALE", "X2"))
        self.pushButton_2.setText(_translate("METHODE_ISO_D_HELICOIDALE", "RETOUR"))
...
if __name__ == "__main__":
    ...
    ui = Ui_METHODE_ISO_D_HELICOIDALE()
    ui.setupUi(METHODE_ISO_D_HELICOIDALE)
